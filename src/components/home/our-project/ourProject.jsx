...
const OurProject = () => {
  return (
    <section className="flex justify-center mt-12 mb-20">
      <div className="w-80 md:w-4/5">
        <div className="mb-7 md:flex md:space-x-10 md:items-end">
          <h1 className="font-medium font-clash-display text-2xl md:text-4xl lg:text-6xl">Our Project Have Been Done</h1>
