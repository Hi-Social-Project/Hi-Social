      ...
      <div className="px-5 grid gap-y-5 grid-cols-1 md:items-center md:grid-cols-2 md:gap-x-8 md:pe-0">
        <div className="font-plus-jakarta-sans flex justify-center">
          <div className=" md:w-9/12 lg:w-3/5">
            <p className="font-semibold text-lg md:text-xl lg:text-3xl">We provide and deliver digital solutions as part of your team</p>
            <h1 className="font-clash-display text-5xl font-semibold my-4 md:text-5xl md:font-medium lg:text-8xl">HiSocial Digital.</h1>
            <p className="text-sm text-justify md:text-base">Kami Adalah HiSocial Digital, Pemasaran dan Desain Kreatif di Yogyakarta, Indonesia. Mari ciptakan pengalaman produk terbaik dengan anggota kami yang berpengalaman</p>
            <button className="btn-blue-rounded-full flex  items-center mt-3 text-xs font-semibold md:px-7 md:text-lg lg:mt-8 lg:mb-5">
